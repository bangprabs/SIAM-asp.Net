<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="aktivasi-anggota.aspx.vb" Inherits="akademik.aktivasi_anggota" %>
...
<body>
    <form id="form1" runat="server">
                ...
                <div class="main-panel">
                    <div class="content-wrapper pb-0">
                        <div class="page-header">
                            <h3 class="page-title"><i class="mdi mdi-home-outline">Aktivasi Anggota</i></h3>
                        </div>
                        <div class="row">
                                                ...
                                                <HeaderTemplate>
                                                    <table class="table table-striped table-bordered" style="margin-bottom: 0px;">
                                                        <tr>
                                                            ...
                                                            <th scope="row">Nama Lengkap
                                                            </th>
                                                            <th scope="row">Email
                                                            </th>
                                                            <th scope="row" style="width: 5px">Aktivasi
                                                            </th>
                                                        </tr>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:LinkButton runat="server" ID="lnkRinci" Text='<%#Eval("nim") %>'
                                                                OnClick="Aktivasi" ForeColor="Blue" Font-Bold="true" CommandArgument='<%# Eval("nim") %>'>
                                                            </asp:LinkButton>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="Label4" runat="server" Text='<%# Eval("nama_lengkap") %>' />
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="Label5" runat="server" Text='<%# Eval("email") %>' />
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("aktivasi") %>' />
                                                        </td>
        ...
        <!-- popup form -->
        <asp:Panel ID="pnlRinci" runat="server" CssClass="modalPopup"
            Style="display: none;">
            <div class="header">
                Aktivasi Anggota
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>NIM</label>
                                <asp:Label ID="lblNIM" runat="server" Text="" CssClass="form-control"></asp:Label>
                            </div>
                            <div class="form-group">
                                <label>Nama Lengkap</label>
                                <asp:Label ID="lblNamaAktivasi" runat="server" Text="" CssClass="form-control"></asp:Label>
                            </div>
                            <div class="form-group">
                                <label>Email</label>
            ...
            <div align="center" class="modal-footer">
                <div class="row">
                    <div class="col-md-12">
                        <button id="btnSimpan" runat="server" class="btn btn-danger">Aktivasi</button>
