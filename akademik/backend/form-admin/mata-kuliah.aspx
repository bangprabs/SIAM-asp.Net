<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="mata-kuliah.aspx.vb" Inherits="akademik.mata_kuliah" %>
                                                                        ...
                                                                        <asp:Repeater ID="rptData" runat="server">
                                                                            ...
                                                                            <ItemTemplate>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:Label ID="lblNama" runat="server" Text='<%# Eval("kode_mk") %>' />
                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:Label ID="lblPilihan" runat="server" Text='<%# Eval("nama_mk") %>' />
                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:Label ID="lblWaktu" runat="server" Text='<%# Eval("sks") %>' />
                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("semester") %>' />
                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:Button ID="btnUbahRinci" Text="Ubah" runat="server" CommandArgument='<%#Eval("kode_mk") %>' OnClick="UbahRinci" />
                                                                                    </td>
                                                                                </tr>
                                                                            </ItemTemplate>
                                                                            <FooterTemplate>
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        <div class="form-group col-md-6" style="margin-bottom: 12px;">
                                                                            <label>Kode MK</label>
                                                                            <asp:TextBox ID="txtKode" runat="server" CssClass="form-control form-control-line" MaxLength="10"></asp:TextBox>
                                                                        </div>
                                                                        <div class="form-group col-md-6" style="margin-bottom: 12px;">
                                                                            <label>Nama MK</label>
                                                                            <asp:TextBox ID="txtNama" runat="server" CssClass="form-control form-control-line" MaxLength="50"></asp:TextBox>
                                                                        </div>
                                                                        <div class="form-group col-md-6" style="margin-bottom: 12px;">
                                                                            <label>SKS</label>
                                                                            <asp:TextBox ID="txtSKS" runat="server" CssClass="form-control form-control-line" MaxLength="2" onkeypress="CheckNumeric(event);"></asp:TextBox>
                                                                        </div>
                                                                        <div class="form-group col-md-6" style="margin-bottom: 12px;">
                                                                            <label>Semester</label>
                                                                            <asp:TextBox ID="txtSemester" runat="server" CssClass="form-control form-control-line" MaxLength="2" onkeypress="CheckNumeric(event);"></asp:TextBox>
                                                                        </div>
                                                                    </div>
                                                                </div>
