<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="registrasi-user.aspx.vb" Inherits="akademik.registrasi_user" %>
                ...
                <div class="main-panel">
                    <div class="content-wrapper pb-0">
                        <div class="page-header">
                            <h3 class="page-title"><i class="mdi mdi-home-outline">Registrasi User</i></h3>
                        </div>
                        <div class="row">
                                                                        ...
                                                                        <asp:Repeater ID="rptData" runat="server">
                                                                            <HeaderTemplate>
                                                                                <table class="table table-striped table-bordered" style="margin-bottom: 0px;">
                                                                                    <tr>
                                                                                        ...
                                                                                        <th scope="row" style="width: 5px">Grup</th>
                                                                                        <th scope="row">Nama Lengkap</th>
                                                                                        <th scope="row" style="width: 5px">Tanggal Buat
                                                                            ...
                                                                            <ItemTemplate>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:Label ID="lblNama" runat="server" Text='<%# Eval("nama_user") %>' />
                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:Label ID="lblPilihan" runat="server" Text='<%# Eval("grup") %>' />
                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:Label ID="lblWaktu" runat="server" Text='<%# Eval("nama_lengkap") %>' />
                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:Label ID="lblTanggal" runat="server" Text='<%# Eval("tanggal_dibuat", "{0:dd-MM-yyyy}") %>' />
                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:Button ID="btnUbahRinci" Text="Ubah" runat="server" CommandArgument='<%#Eval("nama_user") %>' OnClick="UbahRinci" />
                                                                                    </td>
                                                                                </tr>
                                                                            </ItemTemplate>
                                                                            <FooterTemplate>
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        <div class="form-group col-md-6" style="margin-bottom: 12px;">
                                                                            ...
                                                                            <asp:TextBox ID="txtUser" runat="server" CssClass="form-control form-control-line"></asp:TextBox>
                                                                        </div>
                                                                        <div class="form-group col-md-6" style="margin-bottom: 12px;">
                                                                            <label>Kata Sandi</label>
                                                                            <asp:TextBox ID="txtPassword" runat="server" CssClass="form-control form-control-line"></asp:TextBox>
                                                                        </div>
                                                                        <div class="form-group col-md-6" style="margin-bottom: 12px;">
                                                                            <label>Grup User</label>
                                                                            <asp:DropDownList ID="drpGrup" runat="server" CssClass="form-control form-control-line"></asp:DropDownList>
                                                                        </div>
                                                                        <div class="form-group col-md-6" style="margin-bottom: 12px;">
                                                                            <label>Nama Lengkap</label>
                                                                            <asp:TextBox ID="txtNamaFull" runat="server" CssClass="form-control form-control-line"></asp:TextBox>
                                                                        </div>
                                                                    </div>
                                                                </div>
