<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="hasilstudi.aspx.vb" Inherits="akademik.hasilstudi" %>
                ...
                <ul class="nav">
                    <li class="nav-item nav-profile border-bottom">
                        <a href="#" class="nav-link flex-column">
                            ...
                            <img src="/assets/images/unas.png" alt="profile" width="150px" style="margin-bottom: 20px;" />
                ...
                <div class="main-panel">
                    <div class="content-wrapper pb-0">
                        <div class="page-header">
                            <h3 class="page-title">Hasil Studi</h3>
                        </div>
                        <div class="row">
