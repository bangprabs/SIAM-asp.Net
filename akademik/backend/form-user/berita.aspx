<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="berita.aspx.vb" Inherits="akademik.berita" %>
                    ...
                    <div class="content-wrapper pb-0">
                        ...
                        <div class="row">
                            <div class="col-12 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        <asp:ListView ID="lvBerita" runat="server" GroupItemCount="3" GroupPlaceholderID="groupPlaceHolder1"
                                            ...
                                            <ItemTemplate>
                                                <td>
                                                    <table cellpadding="2" cellspacing="0" style="height: 500px">
                                                        <tr>
                                                            <td>
                                                                <img src="../../backend/images/news/<%#Eval("gambar_berita") %>" alt="" style="object-fit: cover" height="200px" width="100%">
                                                                <td>
                                                                    <tr>
                                                                        <td>
                                                                            <h4>
                                                                                <asp:LinkButton runat="server" ID="lnkRinci" Text='<%#Eval("judul_berita") %>'
                                                                                    OnClick="RinciBerita" CommandArgument='<%# Eval("id_berita") %>'></asp:LinkButton></h4>
                                                                        </td>
                                                                    </tr>
                                                                    <td>
                                                                        <i class="mdi mdi-calendar menu-icon"></i>
                                                                        <asp:Label ID="Label5" runat="server" Font-Names="Tahoma" CssClass="Center" Font-Size="Smaller" Text='<%#Eval("tanggal_berita", "{0:dd-MMM-yyyy HH:mm:ss}") %>' />
                                                                        <asp:Label ID="Label2" runat="server" Font-Names="Tahoma" CssClass="Center" Font-Size="Smaller" Text=" | " />
                                                                        <i class="mdi mdi-contacts menu-icon"></i>
                                                                        <asp:Label ID="Label1" runat="server" Font-Names="Tahoma" CssClass="Center" Font-Size="Smaller" Text='<%#Eval("pembuat_berita") %>' />
                                                                        <td>
                                                    </table>
                                                    <td>
                                            </ItemTemplate>
