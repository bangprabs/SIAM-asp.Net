<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="kalender.aspx.vb" Inherits="akademik.kalender1" %>
            ...
            <div class="container d-flex justify-content-between align-items-center">
                ...
                <nav id="navbar" class="navbar">
                    <ul>
                        ...
                        <li class="dropdown"><a class="active" href="#"><span>Akademik</span> <i class="bi bi-chevron-down"></i></a>
                            <ul>
                                                ...
                                                <div class="row">
                                                    <div class="table-responsive">
                                                        <asp:Repeater ID="rptData" runat="server">
                                                            <HeaderTemplate>
                                                                <table class="table table-striped table-bordered" style="margin-bottom: 0px;" cellspacing="0" rules="all">
                                                                    <tr>
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:Label ID="Label2" runat="server" Text='<%# Eval("semester") %>' />
                                                                    </td>
                                                                    <td>
                                                                        <asp:Label ID="Label3" runat="server" Text='<%# Eval("kegiatan") %>' />
                                                                    </td>
                                                                    <td>
                                                                        <asp:Label ID="lblSatu" runat="server" Text='<%# Eval("tanggal") %>' />
                                                                    </td>
                                                                    <td>
                                ...
                                ForeColor="#FF3300"></asp:Label>--%>
                                                        ...
                                                        <tr>
                                                            <td style="padding-bottom: 20px;">
                                                                <asp:Button ID="btnPrevious" runat="server" Text="Balik" Width="80px"></asp:Button>
                                                                <asp:Button ID="btnNext" runat="server" Text="Lanjut" Width="80px"></asp:Button>
                                                            </td>
                                                        </tr>
                                                    </table>
