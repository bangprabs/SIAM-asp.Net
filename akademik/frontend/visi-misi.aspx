<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="visi-misi.aspx.vb" Inherits="akademik.visi_misi" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="main">
            ...
            <h3>Voluptatem dignissimos provident quasi corporis voluptates sit assum perenda sruen jonee trave</h3>
                        ...
                        <div class="col-lg-12">
                            <h3>Visi</h3>
                            <p class="mt-3">Menjadi Perguruan Tinggi yang unggul, bermartabat, mandiri, dan diakui dunia serta memandu perubahan yang mampu meningkatkan kesejahteraan bangsa Indonesia dan dunia. (Sumber: 09/SK/I1-SA/OT/2011)</p>
                            <h3>Misi</h3>
                            <p class="mt-3">Menciptakan, berbagi dan menerapkan ilmu pengetahuan, teknologi, seni dan kemanusiaan serta menghasilkan sumber daya insani yang unggul untuk menjadikan Indonesia dan dunia lebih baik. (Sumber: 09/SK/I1-SA/OT/2011)   </p>
                        </div>
                    </div>
