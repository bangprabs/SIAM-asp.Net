<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="pimpinan.aspx.vb" Inherits="akademik.pimpinan" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="main">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                            <div class="member">
                                <img src="../../frontend/assets/img/staf/arie-gunawan.png" alt="">
                                <h4>Arie Gunawan, S.Kom., MMSI</h4>
                                <span>Rektor</span>
                                <div class="social">
                        ...
                        <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                            <div class="member">
                                <img src="../../frontend/assets/img/staf/maria-sri.png" alt="">
                                <h4>Maria Sri W</h4>
                        ...
                        <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                            <div class="member">
                                <img src="../../frontend/assets/img/staf/andri-hariyanto.png" alt="">
                                <h4>Andri Hariyanto</h4>
                        ...
                        <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                            <div class="member">
                                <img src="../../frontend/assets/img/staf/odong.png" alt="">
                                <h4>Odong</h4>
                        ...
                        <%--<div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <img src="assets/img/staf/casmin.png" alt="">
              <h4>Casmin</h4>
              <span>Tandon & Referensi</span>
              <div class="social">
                <a href=""><i class="bi bi-twitter"></i></a>
                <a href=""><i class="bi bi-facebook"></i></a>
                <a href=""><i class="bi bi-instagram"></i></a>
		  ...
		  <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <img src="assets/img/staf/abdurahman.png" alt="">
              <h4>Abdurahman Saleh</h4>
              <span>PJ Tandon & Referensi</span>
              <div class="social">
                <a href=""><i class="bi bi-twitter"></i></a>
                <a href=""><i class="bi bi-facebook"></i></a>
                <a href=""><i class="bi bi-instagram"></i></a>
		  ...
		  <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <img src="assets/img/staf/delvy.png" alt="">
              <h4>Delvy Aplirizani</h4>
              <span>PJ Upload E-Book & E-Journal</span>
              <div class="social">
                <a href=""><i class="bi bi-twitter"></i></a>
                <a href=""><i class="bi bi-facebook"></i></a>
                <a href=""><i class="bi bi-instagram"></i></a>
		  ...
		  <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <img src="assets/img/staf/egi-setiawan.png" alt="">
              <h4>Egy Setiawan</h4>
              <span>Cyber Library</span>
              <div class="social">
                <a href=""><i class="bi bi-twitter"></i></a>
                <a href=""><i class="bi bi-facebook"></i></a>
                <a href=""><i class="bi bi-instagram"></i></a>
		  ...
		  <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <img src="assets/img/staf/hesti-ari.png" alt="">
              <h4>Hesti Ari Wardani</h4>
              <span>PJ Watermark Karya Ilmiah</span>
              <div class="social">
                <a href=""><i class="bi bi-twitter"></i></a>
                <a href=""><i class="bi bi-facebook"></i></a>
                <a href=""><i class="bi bi-instagram"></i></a>
		  ...
		  <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <img src="assets/img/staf/rahmawati.png" alt="">
              <h4>Rahmawati</h4>
              <span>PJ Upload Bahan Digital</span>
              <div class="social">
                <a href=""><i class="bi bi-twitter"></i></a>
                <a href=""><i class="bi bi-facebook"></i></a>
                <a href=""><i class="bi bi-instagram"></i></a>
		  ...
		  <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <img src="assets/img/staf/yulia.png" alt="">
              <h4>Yulia Zahra Yamini</h4>
              <span>PJ Scan Karya Ilmiah & Cover Buku</span>
              <div class="social">
                <a href=""><i class="bi bi-twitter"></i></a>
                <a href=""><i class="bi bi-facebook"></i></a>
                <a href=""><i class="bi bi-instagram"></i></a>
